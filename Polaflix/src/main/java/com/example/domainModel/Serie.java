...
public class Serie implements Comparable<Serie>, Serializable
{
	...
	// precio que tiene por ver cada cap�tulo
	private double precioCapitulo;
	
	// nombre de la serie
	private String nombre;
	
	// a�o en el que comenz�
	 ...
	 */
	public Serie(List<Temporada> temporadas, double precioCapitulo, String nombre, Integer anhoComienzo, String descripcion,
